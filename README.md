...
This repository showcases an interactive and insightful Social Media Campaign Performance Tracker built using Power BI as part of my internship task at Future Interns.
...
• Analyze key marketing metrics such as Impressions, Clicks, CTR (%), and ROI

• Compare performance across campaign goals and audience segments
...
🔹 Performance Analysis:
  ...
  • CTR and ROI trends across campaign goals
...
🔹 Audience Insights:
  ...
  • Gender-based engagement and ROI

  • Language and platform segmentation
...
• Age groups 25–44 show stronger ROI, while younger audiences contribute more to clicks.

• Higher impressions do not always guarantee higher ROI.
...
• Supports data-driven budget allocation across ad campaigns.

• Identifies high-performing audience segments by age, gender, and language.

• Enables quick performance comparison across campaign goals.
...
• Importance of DAX measures over raw columns in Power BI

• Designing dashboards that answer real business questions
...
• CSV Dataset – Simulated ad campaign data
